...
"""
sandbox-packages documentation build configuration file.
...
VERSION = get_version('../sandbox_packages/sandbox_packages', '__init__.py')
...
project = 'sandbox-packages'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'sandbox-packages'
...
html_context = {
    ...
    "github_repo": 'sandbox-packages',  # Repo name
...
#
# html_title = 'sandbox-packages v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'sandbox_packages'),
                os.path.join(root_path, 'sandbox_packages/migrations')])
